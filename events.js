...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function displayEvents() {
        ...
        db.collection('events')
            .where('date', '>=', today) // Fetch only upcoming events
            .get()
            .then(snapshot => {
                snapshot.forEach(doc => {
                    ...
                    listItem.addEventListener('click', () => displayEventDetails(eventData));
    ...
    removePastEvents(); // Remove past events on page load
    displayEvents(); // Display upcoming events on page load
});
document.addEventListener('DOMContentLoaded', function() {
